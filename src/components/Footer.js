  ...
  return (
    <div className='footer'>
      ...
      <div className='middle-container2'>
        <div><FontAwesomeIcon icon={faEnvelope} className='contact-icon'/> moyinadelowo@gmail.com</div>
        <div><FontAwesomeIcon icon={faPhone} className='contact-icon'/> 08104553618</div>
      </div>
